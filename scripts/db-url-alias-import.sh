...
drush sql-dump --tables-list=url_alias --result-file=../../exports/data/urlaliases_backup.sql
# Export D7 url aliases.
drush sql-dump --database=drupal7db --tables-list=url_alias --result-file=../../exports/data/drupal7_urlaliases.sql
# Import D7 url aliases.
drush sqlq --file=../../exports/data/drupal7_urlaliases.sql
...
rm -f ../../exports/data/drupal7_urlaliases.sql
